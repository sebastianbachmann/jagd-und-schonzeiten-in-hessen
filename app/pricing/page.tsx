      ...
      <div className="w-full flex flex-col items-center mb-24">
        <div className="mx-auto max-w-7xl px-6 xl:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-6 md:text-xl">Kaufen Sie die Übersicht der Jagd- und Schonzeiten in Hessen im PDF Format und als praktische Kalenderdatei für den Import in Ihren Kalender.</p>
          </div>
